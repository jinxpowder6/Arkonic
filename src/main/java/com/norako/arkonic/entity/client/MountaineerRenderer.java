...
public class MountaineerRenderer extends GeoEntityRenderer<MountaineerEntity>
{
    ...
    public MountaineerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new MountaineerModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public ResourceLocation getTextureLocation(MountaineerEntity instance)
    {
        return new ResourceLocation(Arkonic.MOD_ID, "textures/entity/illagers/mountaineer.png");
    }

    @Override
    public RenderType getRenderType(MountaineerEntity animatable, float partialTicks, PoseStack stack,
